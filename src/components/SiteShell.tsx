          ...
          <footer id="site-footer" className={styles.footer}>
            <div className={styles.footerMain}>
              ...
              <div className={styles.footerSocial}>
                <p className={styles.footerSocialHeading}>Follow Our Journey</p>
                <div className={styles.footerSocialIcons}>
                  <a
                    href="https://www.youtube.com/@thechildrenofshingwaukCircle"
                    target="_blank"
                  ...
                  <a
                    href="https://www.facebook.com/childrenofshingwaukalumniassociation/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.footerSocialLink}
                    aria-label="Facebook"
                  ...
                  <a
                    href="https://www.instagram.com/childrenofshingwauk.alumni"
                    target="_blank"
                    rel="noopener noreferrer"
                    className={styles.footerSocialLink}
            ...
            <div className={styles.footerBottom}>
              © 2026 Children of Shingwauk Alumni Association. All Rights Reserved.
            </div>
          </footer>
        </div>
      </div>
